...
main:
  ...
  0000000000000024: 94000000  bl          ?printmsg@@YAHPEBDZZ
...
vprintf:
  0000000000000000: A9BE53F3  stp         x19,x20,[sp,#-0x20]!
  0000000000000004: A9017BF5  stp         x21,lr,[sp,#0x10]
  0000000000000008: AA0003F5  mov         x21,x0
  000000000000000C: 52800020  mov         w0,#1
  0000000000000010: AA0103F3  mov         x19,x1
  0000000000000014: 94000000  bl          __acrt_iob_func
  0000000000000018: AA0003F4  mov         x20,x0
  000000000000001C: 94000000  bl          __local_stdio_printf_options
  0000000000000020: F9400000  ldr         x0,[x0]
  0000000000000024: AA1303E4  mov         x4,x19
  0000000000000028: D2800003  mov         x3,#0
  000000000000002C: AA1503E2  mov         x2,x21
  0000000000000030: AA1403E1  mov         x1,x20
  0000000000000034: 94000000  bl          __stdio_common_vfprintf
  0000000000000038: A9417BF5  ldp         x21,lr,[sp,#0x10]
  000000000000003C: A8C253F3  ldp         x19,x20,[sp],#0x20
